...
**`meow`** exists because I was poor. Dokploy looked nice, but my 2-vCPU, 2-GB server and tiny disk disagreed. So the frontend files went to CDN and OSS, and I wrote my own release platform. It gradually learned to switch versions, undo bad releases and change pages without rebuilding everything. Later **`paw`** appeared because I needed a way to look through what I had put in OSS. A small server somehow produced a small cat family.
...
**`deepsuck`** began as a DeepSeek client. The name was only two letters away from `DeepSeek`. Then Claude Code appeared, I changed sides, and most of the project changed with me. The name turned out to be more accurate than the original plan.
...
- **`ghost`** is empty.
- [**`-`**](https://github.com/yuxino/-/issues/14) hides a 2020 note where I turned shortest paths into a career decision tree and concluded that almost every route looked bad except learning. I also predicted that someone might dig it up and embarrass me. Someone did.
